...
void
CameraCalibration::drawResultsInitial( std::vector< cv::Mat >& images, std::vector< std::string >& imageNames, cv::Mat& DistributedImage ) const
{
...
void
CameraCalibration::drawResultsFiltered( std::vector< cv::Mat >& images, std::vector< std::string >& imageNames, cv::Mat& DistributedImage ) const
{
