#ifndef CAMERACALIBRATION_TEST_H
#define CAMERACALIBRATION_TEST_H
...
class CameraCalibrationTest
{
    ...
    CameraCalibrationTest( const std::string& cameraFile, //
    ...
    double reprojectionError( const std::vector< std::vector< cv::Point3f > >& objectPoints,
                              ...
                              cv::OutputArray _perViewErrors = cv::noArray( ) ) const;
    ...
    bool CalibrationDataTest( CameraPtr& camera,
                              std::vector< cv::Mat >& rvecs,
                              std::vector< cv::Mat >& tvecs,
                              std::vector< std::vector< cv::Point2f > >& imagePoints,
                              std::vector< std::vector< cv::Point3f > >& scenePoints ) const;
